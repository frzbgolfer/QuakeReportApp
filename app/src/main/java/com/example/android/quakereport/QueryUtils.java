...
//            "{\"type\":\"Feature\",\"properties\":{\"mag\":5,\"place\":\"Pacific-Antarctic Ridge\",\"time\":1451986454620,\"updated\":1459202978040,\"tz\":-540,\"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004bgk\",\"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004bgk&format=geojson\",\"felt\":0,\"cdi\":1,\"mmi\":0,\"alert\":\"green\",\"status\":\"reviewed\",\"tsunami\":0,\"sig\":554,\"net\":\"us\",\"code\":\"10004bgk\",\"ids\":\",us10004bgk,gcmt20160105093415,\",\"sources\":\",us,gcmt,\",\"types\":\",cap,dyfi,geoserve,losspager,moment-tensor,nearby-cities,origin,phase-data,shakemap,\",\"nst\":null,\"dmin\":30.75,\"rms\":0.67,\"gap\":71,\"magType\":\"mww\",\"type\":\"earthquake\",\"title\":\"M 6.0 - Pacific-Antarctic Ridge\"},\"geometry\":{\"type\":\"Point\",\"coordinates\":[-136.2603,-54.2906,10]},\"id\":\"us10004bgk\"}],\"bbox\":[-153.4051,-54.2906,10,158.5463,59.6363,582.56]}";
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a {@link List} object of earthquakes
...
// If the JSON string is empty or null, then return early.
        ...
        // Try to parse the JSONObject. If there's a problem with the way the JSON
        ...
        try {
            ...
            for(int i=0; i<jsonArrayFeatures.length(); i++){
                JSONObject jsonObjectEarthquake = jsonArrayFeatures.getJSONObject(i);
                JSONObject jsonObjectProperties = jsonObjectEarthquake.getJSONObject("properties");
                double curEQMag = jsonObjectProperties.getDouble("mag");
                String curEQLoc = jsonObjectProperties.getString("place");
                long curEQDate = jsonObjectProperties.getLong("time");
                String eqURL = jsonObjectProperties.getString("url");

                Earthquake earthquake = new Earthquake(curEQMag, curEQLoc, curEQDate, eqURL);
